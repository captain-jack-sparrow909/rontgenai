...
export function PulseAtmosphere() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden" aria-hidden>
      <div className="absolute -left-24 top-0 h-[400px] w-[400px] rounded-full bg-emerald-500/15 blur-[120px]" />
      <div className="absolute -right-16 top-32 h-[340px] w-[340px] rounded-full bg-teal-500/15 blur-[100px]" />
      <div className="absolute bottom-10 left-1/3 h-[260px] w-[420px] rounded-full bg-cyan-600/10 blur-[110px]" />
      <div
  ...
  return (
    <div
      className={cn(
        ...
        glow && "shadow-emerald-500/10 ring-1 ring-emerald-400/20",
        className,
      )}
    >
